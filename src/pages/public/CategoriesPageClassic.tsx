/**
 * PREVIOUS categories design — kept verbatim so it can be restored on request.
 *
 * To go back to it, point the `categories` route at this component instead of
 * `CategoriesPage` in `src/routes/index.tsx`. Nothing else references this
 * file, so it costs nothing to keep around.
 *
 * Layout: alternating image / text rows, one category per row.
 */
...
export function CategoriesPageClassic() {
